 ...
 */
		  switch ($_SERVER["HTTP_HOST"]){
	  		case "50.116.60.112" : 		
	  		case "inara.sproklet.com" : define('ENVIRONMENT', 'production'); break;
            case "staging.click3x.com": define('ENVIRONMENT','cfm_staging'); break;
            case "dev.click3x.com": 	define('ENVIRONMENT','cfm_dev'); break;
			case "sam.dev": 			define('ENVIRONMENT','ored'); break;
			case "camera.samsung.dev": 	define('ENVIRONMENT','jason'); break;
