...
set_include_path($root . '/' . PATH_SEPARATOR 
                 . get_include_path() 
                ); 
/**
 * Load Exceptions
...
class PBAPI {
     ...
     */
    public function __construct($params, $type = null, $subdomain = 'api', $default_format = 'xml', $type_params = array()) {
        $this->_loadMethodClass('base');
        $consumer_key 		= $params['customer_key'];
        $consumer_secret 	= $params['customer_secret'];
