...
define('INSTALLED_PAGE_URL',					'http://www.facebook.com/SamsungStaging/app_227391110700622'); // This is a fallback value. The installed page url will be set by the facebook signed request when available.
define('ABSOLUTE_URL',							"http://dev.click3x.com/bigfuel/samsungcamera/");
/*
|--------------------------------------------------------------------------
